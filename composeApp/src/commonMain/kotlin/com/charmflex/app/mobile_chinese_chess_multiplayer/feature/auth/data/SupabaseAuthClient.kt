package com.charmflex.app.mobile_chinese_chess_multiplayer.feature.auth.data
...
class SupabaseAuthClient {
    private val supabaseClient =
        createSupabaseClient(AuthConstant.SUPABASE_URL, AuthConstant.SUPABASE_ANON_KEY) {
            install(Auth) {
                flowType = FlowType.PKCE
                scheme = AuthConstant.DEEP_LINK_SCHEME
                host = AuthConstant.DEEP_LINK_HOST
            }
        }
